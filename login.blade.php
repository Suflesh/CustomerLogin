        ...
        <div class="row">
            ...
            <div class="col-6"
                ...
                <p style="margin-top: 20px;">
                    <h1 style="text-align: center;justify-content: center;">CUSTOMER LOGIN HERE</h1>
                    <hr>
                ...
                <form action="cuslog" method="post">
                    @csrf
                    EMAIL:<span>@error('email'){{$message}}@enderror</span>
                    ...
                    PASSWORD:<span>@error('password'){{$message}}@enderror</span>
                    <input type="password" name="password" class="form-control" placeholder="PASSWORD.."
                        style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;border-top-left-radius: 20px;border-top-right-radius: 20px;"><br>
                    <input type="submit" class="btn btn-success" value="LOGIN"><br><br>
                    <a href="home">New User</a>
